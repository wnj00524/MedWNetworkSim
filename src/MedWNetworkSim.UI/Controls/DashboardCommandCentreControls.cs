...
internal sealed class BottleneckLeaderboard : Border
{
    public BottleneckLeaderboard(WorkspaceViewModel vm)
    {
        ...
        Rebuild(); vm.PropertyChanged+=(_,e)=>{ if(e.PropertyName==nameof(WorkspaceViewModel.Bottlenecks)) Rebuild();};
    }
}
...
internal sealed class InsightRail : Border
{
    public InsightRail(WorkspaceViewModel vm)
    {
        ...
        Rebuild(); vm.PropertyChanged += (_,e)=>{ if(e.PropertyName==nameof(WorkspaceViewModel.InsightCards)) Rebuild();};
    }
}
...
internal sealed class TimelineStrip : Border
{
    public TimelineStrip(WorkspaceViewModel vm)
    {
        ...
        Rebuild(); vm.PropertyChanged += (_,e)=>{ if(e.PropertyName==nameof(WorkspaceViewModel.TimelineMetrics)) Rebuild();};
    }
}
